...
public:
	...
	int insertNoVoHT(TaskDAG &dag, int &num_tasks, int &numSleep, ZHTClient &clientRet);
	int insertWaitQ(TaskDAG &dag, int &numSleep, int &num_tasks, int &computeSlots, int &max_tasks_per_package, ZHTClient &clientRet);
