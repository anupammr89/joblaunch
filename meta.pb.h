...
class Package : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_numslots() const;
  inline void clear_numslots();
  static const int kNumslotsFieldNumber = 28;
  inline ::google::protobuf::uint32 numslots() const;
  inline void set_numslots(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 numslots_;
...
// optional uint32 numslots = 28;
inline bool Package::has_numslots() const {
  return _has_bit(7);
}
inline void Package::clear_numslots() {
  numslots_ = 0u;
  _clear_bit(7);
}
inline ::google::protobuf::uint32 Package::numslots() const {
  return numslots_;
}
inline void Package::set_numslots(::google::protobuf::uint32 value) {
  _set_bit(7);
  numslots_ = value;
}
