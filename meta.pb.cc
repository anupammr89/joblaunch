...
void protobuf_AssignDesc_meta_2eproto() {
  ...
  static const int Package_offsets_[27] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Package, numslots_),
...
void protobuf_AddDesc_meta_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "currnode\030\006 \001(\r\022\017\n\007numwait\030\007 \001(\r", 511);
...
const int Package::kNumslotsFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 27: {
        ...
        if (input->ExpectTag(224)) goto parse_numslots;
        break;
      }
      
      // optional uint32 numslots = 28;
      case 28: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_numslots:
...
void Package::SerializeWithCachedSizes(
  ...
  // optional uint32 numslots = 28;
  if (_has_bit(7)) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(28, this->numslots(), output);
  }
...
::google::protobuf::uint8* Package::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 numslots = 28;
  if (_has_bit(7)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(28, this->numslots(), target);
  }
...
void Package::Swap(Package* other) {
  if (other != this) {
    ...
    std::swap(numslots_, other->numslots_);
